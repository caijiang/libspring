...
/**
 * <p>启动器</p>
 * <p>{@link org.luffy.lib.libspring.loader.MutliDispatcherLoader}是一个多Dispatcher启动器，并不在常见场合中使用。</p>
 ...
 *     }
 * </pre>
 * <p>MVC的实现请创建类继承与{@link org.luffy.lib.libspring.loader.SimpleMVCLoader}</p>
 * <pre class="code">
