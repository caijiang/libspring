...
//    private static final org.slf4j.Logger getSLFLogger(final Log log){
//        org.slf4j.Logger l =null;
//        if (log instanceof org.slf4j.Logger){
//            l = (org.slf4j.Logger)log;
//            l.
//        }
//
//    }
    ...
    private static final Logger getLog4JLogger(final Log log) {
        ...
        if (log instanceof Log4JLogger) {
            ...
            try{
                Object current = log;
                while (true){
                    Field field = current.getClass().getDeclaredField("logger");
